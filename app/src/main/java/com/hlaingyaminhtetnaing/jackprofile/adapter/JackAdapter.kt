...
class JackAdapter(var jackList:ArrayList<Jack>) : RecyclerView.Adapter<JackAdapter.jackViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): jackViewHolder {
        var view= LayoutInflater.from(parent.context).inflate(R.layout.item_eachofme,parent,false)
